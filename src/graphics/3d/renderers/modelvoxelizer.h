#ifndef MODELVOXELIZER_H
#define MODELVOXELIZER_H
...
namespace Fondue { namespace graphics {
    ...
    class ModelVoxelizer : public RenderPass<EMPTY, EMPTY>
    {
    ...
    public:
        ...
        ModelVoxelizer()
        {
            makePipelineShader("src/shaders/voxelizer.vs", "src/shaders/gensdf.fs");
        }
